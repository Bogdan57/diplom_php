...
if (isset($_SESSION['login']) || isset($_COOKIE['login'])) { 
    ...
    <div class="sidebar">
        ...
        <?php if ($user->role == 'manager') { ?>
            <a class="create-task-button" href="index.php?new=true<?=$filter_param;?>">Создать новое</a>
        <?php } ?>
    </div>
    ...
    <div class="content">
        ...
        if (isset($_GET['new'])) {
            ...
            if (count($tasks) == 0) echo '<p class="info-message">Заданий не найдено</p>';
                ...
                <div class="task-wrap">
                    ...
                    <div class="task-footer">
                        ...
                        <div class="task-buttons">
                            <?php if ($value['status'] == 'resolved') echo '<a class="task-button" href="index.php?check=' . $value['id'] . '">Проверить</a>'; ?>
                            <a class="task-button task-button_edit" href="index.php?edit=<?=$value['id']?><?=$filter_param;?>">Редактировать</a>
                            <a class="task-button task-button_delete" href="index.php?delete=<?=$value['id']?><?=$filter_param;?>">Удалить</a>
                        </div>
                        <?php } ?>
